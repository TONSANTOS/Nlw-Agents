...
import type { GetRoomQuestionsResponse } from "./types/get-room-questions-reponse";
...
export function useCreateQuestion(roomId: string) {
    ...
    return useMutation({
        ...
        // onMutate executa no momento que for feita a chamada para a API
        onMutate: ({ question }) => {
            // interface otimista, mostrar as informações pro usuário mesmo que ainda não seja real
